...
try {
    ...
    $sql = "SELECT treatment_name, treatment_price FROM treatment WHERE salon_id = 1";
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/barber1.css">
</head>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption">
                            ...
                            <p class="mb-30 pera-bottom">A Hairway To Heaven egy kis borbélyboltként indult, két borbélyjal és egy székkel! Hosszú utat tettünk meg, egy szomszédsági borbélyboltból egy elismert és széles körben ismert helyszínné váltunk, több mint 2000 havi ügyféllel, akik közül néhányan az első naptól kezdve visszajárnak!</p>
                            <p class="pera-top mb-50">Ha a hajad a poklon keresztül megy, itt az idő, hogy belépjen a Hairway To Heavenbe.</p>
            ...
            <div class="container">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-7 col-lg-8 col-md-11 col-sm-11">
                        ...
                        <h2>A legjobb szolgáltatások, amiket Önnek kínálunk</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="section-tittle text-center mb-100">
                       ...
                       <?php if ($isLoggedIn): ?>
                                <button class="reservation-button">
                                    <a href="appointment1/reservation.php" style="text-decoration: none; color: white;">Foglalás</a>
                                </button>
                            <?php else: ?>
                                <button class="reservation-button">
