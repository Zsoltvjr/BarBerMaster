...
try {
    ...
    $sql = "SELECT treatment_name, treatment_price FROM treatment WHERE salon_id = 3";
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/barber3.css">
</head>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption">
                            ...
                            <span>Rólunk</span>
                            <h2>30 Év Tapasztalat a Hajvágásban!</h2>
                            </div>
                            <p class="mb-30 pera-bottom">A Hair Hub egy kis borbélyboltként indult, csupán két borbélyjal és egy székkel. Ma már egy elismert és széles körben ismert helyszínné nőttük ki magunkat, több mint 2000 havi ügyféllel, akik közül sokan már az első naptól kezdve hűséges visszatérőink!</p>
                            <p class="pera-top mb-50">Ha a hajad már megjárta a poklot, itt az ideje, hogy belépjen a Hair Hubba, ahol újra paradicsomra találhat.</p>
                        ...
                        <div class="col-md">
                            ...
                            <?php if ($isLoggedIn): ?>
                                <button class="reservation-button">
                                    <a href="appointment3/reservation.php" style="text-decoration: none; color: white;">Foglalás</a>
                                </button>
                            <?php else: ?>
                                <button class="reservation-button">
