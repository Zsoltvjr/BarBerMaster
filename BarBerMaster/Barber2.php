...
try {
    ...
    $sql = "SELECT treatment_name, treatment_price FROM treatment WHERE salon_id = 2";
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/barber2.css">
</head>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption">
                            ...
                            <p class="mb-30 pera-bottom">A Trim Trends kis borbélyboltként kezdte pályafutását, mindössze két borbélyjal és egy székkel. Ma már egy elismert és széles körben ismert helyszínné váltunk, több mint 2000 havi ügyféllel, akik közül sokan az első naptól kezdve visszatérnek!</p>
                            <p class="pera-top mb-50">Ha a hajad már megjárta a poklot, itt az ideje, hogy belépjen a Trim Trendsbe.</p>
                        ...
                        <div class="col-md">
                            ...
                            <?php if ($isLoggedIn): ?>
                                <button class="reservation-button">
                                    <a href="appointment2/reservation.php" style="text-decoration: none; color: white;">Foglalás</a>
                                </button>
                            <?php else: ?>
                                <button class="reservation-button">
