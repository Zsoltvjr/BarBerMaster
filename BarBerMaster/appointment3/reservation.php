                        ...
                        <form id="addReservationForm" method="post" action="add_reservation.php" class="archive-form">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="frizer_id" class="form-select" id="frizer_id">
                                    <?php
                                    $frizers = $pdo->query("SELECT frizer_id, frizer_name FROM frizers WHERE salon_id = 3")->fetchAll(PDO::FETCH_ASSOC);
                            ...
                            <div class="mb-3">
                                ...
                                <select name="treatment_id" class="form-select" id="treatment_id">
                                    <?php
                                    $treatments = $pdo->query("SELECT treatment_id, treatment_name, treatment_price FROM treatment WHERE salon_id = 3")->fetchAll(PDO::FETCH_ASSOC);
