...
try {
    ...
    $sql = "SELECT treatment_name, treatment_price FROM treatment WHERE salon_id = 5";
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/barber5.css">
</head>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption">
                            ...
                            <span>Rólunk</span>
                        <h2>30 Év Hajra-Kapcsolatos Tapasztalat!</h2>
                    <p class="mb-30 pera-bottom">A Vajer's Place egy apró borbélybolt volt, ami egy pizzéria alagsorában kezdte pályafutását, mindössze egy székkel és egy múzeumból valóképesnek tűnő régi ollóval. Az évtizedek alatt több hajat vágtunk le, mint ahány szelet nagy pizzában van! Több mint 2000 hűséges ügyféllel havonta tökéletesítettük a hajvágás művészetét, mindezt vidám és könnyed hangulatban. Az ollóink mindent láttak— a diszkó korszakától kezdve a legújabb trendekig!</p>
                        <p class="pera-top mb-50">Szóval, ha a hajad csomókba állt vagy teljes átalakításra szorul, gyere a Vajer's Place-be, ahol már 52 éve fordítjuk meg a fejeket (és néha még a pizzákat is)!</p>
                        ...
                        <div class="col-md">
                            ...
                            <?php if ($isLoggedIn): ?>
                                <button class="reservation-button">
                                    <a href="appointment5/reservation.php" style="text-decoration: none; color: white;">Foglalás</a>
                                </button>
                            <?php else: ?>
                                <button class="reservation-button">
