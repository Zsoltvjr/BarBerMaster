...
<body>
  <h1>Reservations</h1>
  <button id="btn-active">Aktív foglalások</button>
  <button id="btn-archived">Archivált foglalások</button>
  <button id="btn-cancelled">Lemondott foglalások</button>
  <br><br>
  <a href="cancel.php">Lemondás</a>
